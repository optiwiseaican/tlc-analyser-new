...
class AllExportedFiles : AppCompatActivity(), OnPDFSelectListener {
...
//        runtimePermission()
    ...
    private fun runtimePermission() {
        Dexter.withContext(this@AllExportedFiles).withPermissions(
            Manifest.permission.READ_EXTERNAL_STORAGE,
            Manifest.permission.WRITE_EXTERNAL_STORAGE
        )
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == STORAGE_PERMISSION_REQUEST_CODE) {
            ...
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Source.toast(this@AllExportedFiles, "We need permission to access these files")
...
//        recyclerView.layoutManager = layoutManager
        ...
        pdfList.addAll(findPDF(applicationContext.getExternalFilesDir(getString(R.string.folderLocation)))!!)
    ...
    override fun onPDFSelected(file: File?, fileName: String, position: Int) {
        val intent = Intent(this@AllExportedFiles, PDFActivity::class.java)
